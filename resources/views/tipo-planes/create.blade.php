@extends('dashboard')
@section('title', 'CrearPlan')

@section('content')
<div class="container-fluid px-4">
    <h1 class="mt-4">Crear nuevo plan</h1>
    <form action="{{ route('tipo-planes.store') }}" method="POST">
        @csrf
        <div class="mb-3">
            <label for="tipo_plan" class="form-label">Nombre del Plan</label>
            <input type="text" id="tipo_plan" name="tipo_plan" class="form-control" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" id="dias_por_semana" name="dias_semana" class="form-control" required>
        </div>
